...
while true; do
    ...
    ENHANCED_COUNT=$(PGPASSWORD=call_insights_pass psql -U call_insights_user -d call_insights -h localhost -t -c "SELECT COUNT(*) FROM call_resolutions WHERE problem_complexity IS NOT NULL;" | xargs)
