...
class EmailSender:
    ...
    async def send_report(
        ...
        full_subject = f"[COWS Report] {subject} - {timestamp}"
    ...
    async def send_alert(
        ...
        <body>
            ...
            <div class="footer">
                ...
                <p>Generated by COWS Call Intelligence System at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</p>
            </div>
        </body>
        </html>
        """
...
if __name__ == "__main__":
    async def test():
        ...
        success = await sender.send_alert(
            alert_type="test",
            title="Test Alert",
            message="This is a test alert from the COWS system.",
            priority="normal",
