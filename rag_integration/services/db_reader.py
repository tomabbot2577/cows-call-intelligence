...
class DatabaseReader:
    ...
    def __init__(self, database_url: Optional[str] = None):
        ...
        self.database_url = database_url or os.getenv(
            "RAG_DATABASE_URL",
            "postgresql://call_insights_user:call_insights_pass@localhost/call_insights"
        )
    ...
    def get_calls_for_export(
        ...
        SELECT
            ...
            rec.followup_actions,
            rec.knowledge_base_updates,
            rec.escalation_needed as rec_escalation_needed,
            rec.risk_level,
